...
- "diligenc\w*\s+it\b" | regex: true | severity: 4 | source: clearfelt-writing-heuristic
- "diligenc\w*\s+this\b" | regex: true | severity: 4 | source: clearfelt-writing-heuristic
- "diligenc\w*\s+that\b" | regex: true | severity: 4 | source: clearfelt-writing-heuristic
- "diligenc\w*\s+them\b" | regex: true | severity: 4 | source: clearfelt-writing-heuristic
